define ['backbone'], (Backbone) ->
  class Order extends Backbone.Model
    ...
    validate: (attrs, options) ->
      isValid = true
      requiredFields = ['startPointTitle', 'endPointTitle', 'startPoint', 'endPoint', 'distance', 'price', 'date',
                        'name']
    ...
    updatePrice: ->
      ...
      while i < path.length
        ...
        distance += google.maps.geometry.spherical.computeDistanceBetween(new google.maps.LatLng(start[0], start[1]),
